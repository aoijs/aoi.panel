...
(function (r, i) {
  ...
  $.fn.on_load = function (e) {
    var n = $.extend({ error: $.noop, load: $.noop, done: $.noop }, e);
    var r = [];
  ...
  FormatBuffer.prototype.format = function e(t, n, r) {
    ...
    var a = { line: $.terminal.format(t, this._settings), raw: r, newline: n };
    if (i) {
  ...
  $.fn.cmd = function (z) {
    ...
    if (is_mobile) {
      B = (function () {
        var t = $('<div class="cmd-editable" contenteditable/>')
          .attr({
            autocapitalize: "off",
            autocorrect: "off",
            spellcheck: "false",
        ...
        var n = {
          ...
          focus: function () {
            css(t[0], { top: "calc(var(--terminal-scroll, 0) * 1px)" });
            n.reset();
          },
          blur: function () {
      ...
      ENTER: function () {
        if (
          ...
          ((is_function(x.historyFilter) && x.historyFilter(T)) ||
            (x.historyFilter instanceof RegExp && T.match(x.historyFilter)) ||
            !x.historyFilter)
        ) {
          c.append(T);
        }
        ...
        if (Oe(t)) {
          ...
          if (o === 0 && a.length === 1) {
            ...
            if (f <= c) {
              ...
              b(D, { length: a.length, position: p });
              E(a.slice(0, m));
              w(a.slice(m + 1));
            }
          }
      ...
      function i(e) {
        ...
        return r
          ...
          .map(function (e) {
            ...
            return (
              '<span class="cmd-line">' + $.terminal.format(e, i) + "</span>"
            );
          })
          .concat([a])
          .join("\n");
    ...
    k.data("cmd", k);
    if (
      !("KeyboardEvent" in window && "key" in window.KeyboardEvent.prototype)
    ) {
      setTimeout(function () {
        throw new Error(
    ...
    if (typeof wcwidth !== "undefined") {
      ...
      var i = r
        ...
        .reduce(function (e, t) {
          ...
          if (n) {
            if (n.len !== t.len) {
              return e.concat([{ sum: t.len, len: t.len, specs: [t] }]);
            } else {
              e.pop();
              return e.concat([
                { sum: n.sum + t.len, len: n.len, specs: n.specs.concat(t) },
              ]);
            }
          }
  ...
  function process_command(e, t) {
    ...
    if (r.length) {
      ...
      return { command: e, name: "", args: [], args_quotes: [], rest: "" };
    }
  }
  $.terminal = {
    version: "2.37.2",
    ...
    split_equal: function e(t, p, n) {
      ...
      var m = $.extend({ trim: false, keepWords: false }, n);
      var D = "";
      var d = [];
      ...
      for (var u = 0, a = r.length; u < a; ++u) {
        ...
        $.terminal.iterate_formatting(h, function e(t) {
          ...
          if (
            t.length >= p ||
            t.last ||
            (t.length === p - 1 && strlen(h[t.index + 1]) === 2)
          ) {
            var i = false;
            ...
            d.push(_);
            return { index: s, length: 0, space: -1 };
          }
        });
      }
      return d;
        ...
        if (m) {
          if (!settings.invokeMethods) {
            ...
            try {
              ...
              term.error(
                "Invalid invocation in " + $.terminal.escape_brackets(string)
              );
              deferred.reject();
            }
          }
  ...
  (function () {
    ...
    function l(n, r) {
      return function (e) {
        ...
        if (!t) {
          warn(
            "Invalid URL " + e + " only http(s) ftp and path " + "are allowed"
          );
        }
        return t;
      };
    ...
    $.terminal.format = function i(e, t) {
      ...
      function i(e, t, n, r, i, u, a) {
        ...
        if ($.terminal.valid_color(n)) {
          $.extend(c, { color: n, "--color": n, "--original-color": n });
          if (t.indexOf("!") !== -1) {
            c["--link-color"] = n;
          }
          if (t.indexOf("g") !== -1) {
        ...
        if ($.terminal.valid_color(r)) {
          $.extend(c, { "background-color": r, "--background": r });
        }
        var m = F(u, a);
        var D = extra_css(a, g);
        if (D) {
  ...
  $.jrpc = function (e, t, n, r, i) {
    ...
    if ($.isPlainObject(e)) {
      ...
      s = { url: e, method: t, params: n, success: r, error: i };
    }
    function u(e) {
      return (
        $.isNumeric(e.id) &&
        (typeof e.result !== "undefined" || typeof e.error !== "undefined")
      );
    }
    ...
    function f(e, t, n, r) {
      if (u(e) || s.method === "system.describe") {
        ...
        o.reject({ message: "Invalid JSON-RPC", response: t });
      }
    }
    $.ajax({
      url: s.url,
      ...
      success: function e(t, n, r) {
        ...
        try {
          ...
          o.reject({ message: "Invalid JSON", response: t });
          return;
        }
  ...
  $.terminal.defaults = {
    ...
    unixFormatting: { escapeBrackets: false, ansiParser: {}, ansiArt: false },
    onAjaxError: null,
    pasteImage: true,
    ...
    strings: {
      ...
      wrongArity:
        "Wrong number of arguments. Function '%s' expects %s got" + " %s!",
  ...
  $.fn.terminal = function (e, t) {
      ...
      return function (e, t) {
        ...
        if (i === "function") {
          if (o && r.length !== n.args.length) {
            g.error(
              "&#91;Arity&#93; " +
                sprintf(c().wrongArity, n.name, r.length, n.args.length)
            );
          } else {
            ...
            if ($.isPlainObject(i) && typeof i.name === "string") {
              t[i.name] = function () {
                ...
                if (C.checkArity && i.params && i.params.length !== n) {
                  g.error(
                    "&#91;Arity&#93; " +
                      sprintf(c().wrongArity, i.name, i.params.length, n)
                  );
                } else {
                  g.pause(C.softPause);
                  if (e) {
    ...
    function G(t, a, n) {
      ...
      if (e === "array") {
        ...
        n({ interpreter: Q(t, C.checkArity, a), completion: Object.keys(t) });
      } else {
        if (e === "undefined") {
          t = $.noop;
        } else if (e !== "function") {
        ...
        n({ interpreter: t, completion: C.completion });
      }
    }
    function X(r, e) {
    ...
    function ee(e, t) {
      return (
        ...
        ((C.wrap === true && t.wrap === undefined) ||
          (C.wrap === false && t.wrap === true))
      );
    }
    var f;
    if ("Map" in root) {
        ...
        return $.terminal.each_extended_command(e, function (e) {
          if (r.exec) {
            ...
            if (_ && _ === t) {
              ...
              _ = t;
              $.terminal
                .extended_command(g, e, { invokeMethods: r.invokeMethods })
                .then(function () {
                  _ = "";
                });
            }
      ...
      try {
        ...
        if (r !== "") {
          if (!n.raw) {
            ...
            if (n.formatters) {
              try {
                r = $.terminal.apply_formatters(r, $.extend(C, { echo: true }));
              } catch (e) {
                D(e, "FORMATTING");
              }
            }
            ...
            r = $.terminal.encode(r, { tabs: C.tabs });
            var o;
            var s = (n.cols = g.cols());
            if (ee(r, n)) {
    ...
    function me(n, e, t) {
      ...
      try {
        ...
        if (!Fe()) {
          if (
            t &&
            ((is_function(C.historyFilter) && C.historyFilter(n)) ||
              n.match(C.historyFilter))
          ) {
            B.history().append(n);
          }
        }
    ...
    function Re(a, o, s) {
      return function e(r, i) {
        var u = new $.Deferred();
        p(function e() {
          var t = $.extend({ typing: false, delay: C.execAnimationDelay }, i);
          if (t.typing) {
            if (typeof r !== "string") {
            ...
            if (typeof t.delay !== "number" || isNaN(t.delay)) {
              return u.reject(
                a + ": Invalid argument, delay need to" + " be a number"
              );
            }
      ...
      g.push(
        function (i) {
          g.set_mask(C.maskChar).push(
            ...
            { prompt: c().password + ": ", name: "password" }
          );
        },
        { prompt: c().login + ": ", name: "login" }
      );
    }
    function Le(t) {
      return function (e) {
    ...
    function Ie() {
      ...
      var i = e("top");
      var u = e("bottom");
      return { top: i, left: n, right: r, bottom: u };
    }
    var g = this;
    if (this.length > 1) {
      return this.each(function () {
        $.fn.terminal.call($(this), e, $.extend({ name: g.selector }, t));
      });
    }
    var Pe;
    if (g.is("body,html")) {
    ...
    var Me = $.omap(
      {
        ...
        resize: function (e, t) {
          if (!g.is(":visible")) {
            ...
            t = g.height();
            if (
              typeof C.numChars !== "undefined" ||
              typeof C.numRows !== "undefined"
            ) {
        ...
        refresh: function () {
          if (L.width !== 0) {
            css(g[0], { "--char-width": L.width, "--pixel-density": O });
          }
          g.clear_cache();
          if (Ke) {
            B.resize();
          }
          re({ scroll: false, update: true });
          return g;
        },
        flush: function (d) {
          ...
          p(function e() {
            try {
              ...
              var n;
              if (l.length === 0) {
                css(B[0], { "--prompt-offset": "", top: "" });
                B.__set_prompt_margin(0);
                n = g.find(
                  ".terminal-output div:last-child" + " div:last-child"
                );
                ...
                css(B[0], { top: -i.height / O + "px", "--prompt-offset": c });
          ...
          p(function e() {
            ...
            if (!w.valid_index(r)) {
              ...
              unpromise(t, function (e) {
                ...
                i = w.update(r, e, i);
                var n = ne({ value: e, index: r, options: i });
            ...
            try {
              ...
              if (u.typing) {
                ...
                if (typeof u.delay !== "number" || isNaN(u.delay)) {
                  return s.reject(
                    "echo: Invalid argument, delay need to" + " be a number"
                  );
                }
              ...
              unpromise(
                ...
                function (e) {
                  ...
                  var r = ne({ value: e, options: u, index: t });
                  if (is_promise(r)) {
                    We = true;
                  }
                  w.push([e, u]);
        ...
        read: function (e, t, n) {
          ...
          if (typeof arguments[1] === "object") {
            ...
            r = { typing: false, success: t || $.noop, cancel: n || $.noop };
          }
          if (r.typing) {
            var i = g.get_prompt();
            r.typing = false;
        ...
        destroy: function () {
          p(function e() {
            ...
            g.find(
              ".terminal-fill, .terminal-font, .terminal-font-forcer"
            ).remove();
            g.stopTime();
            terminals.remove(m);
            if (T) {
    ...
    G(e, C.login, function (e) {
      if (
        (C.completion && typeof C.completion !== "boolean") ||
        !C.completion
      ) {
      ...
      if (is_mobile) {
        ...
        (function () {
          ...
          function u() {
            if (
              n.is(".terminal") ||
              n.is(".terminal-scroller") ||
              n.is(".terminal-wrapper")
            ) {
      ...
      function a() {
        ...
        $('<div class="terminal-font-forcer terminal-hidden">x<div>').appendTo(
          g
        );
      }
      function o(e) {
        Xe = e[0].intersectionRatio >= 0.9;
      }
      function s() {
      ...
      function l() {
        ...
        if (window.IntersectionObserver && g.css("position") !== "fixed") {
          T = new IntersectionObserver(n, { root: null });
          T.observe(g[0]);
        } else {
          T = setInterval(n, 100);
        }
      ...
      if (c) {
        ...
        ot.observe(document.body, { childList: true });
      }
      if (f) {
        l();
      }
        ...
        if (location.hash) {
          setTimeout(function () {
            try {
              ...
              var n = 0;
              var r = { typing: C.execAnimation, delay: C.execAnimationDelay };
              (function e() {
