  ...
  class m {
    static validateConfigurationOptions(r) {
      ...
      if (
        ...
        Array.isArray(r.ignoreDuplicateModules) ||
          (r.ignoreDuplicateModules = []),
        r.baseUrl.length > 0 &&
        ...
        r.nodeCachedData &&
          ...
          (typeof r.nodeCachedData.seed != "string" &&
            (r.nodeCachedData.seed = "seed"),
    ...
    static mergeConfigurationOptions(r = null, c = null) {
      ...
      return (
        u.Utilities.forEachProperty(r, (t, e) => {
          ...
          typeof a.ignoreDuplicateModules < "u"
  ...
  class p {
    ...
    _createIgnoreDuplicateModulesMap() {
      ...
      for (let r = 0; r < this.options.ignoreDuplicateModules.length; r++)
        this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[r]] =
          !0;
    }
    ...
    _applyPaths(r) {
      ...
      for (let a = 0, t = this.sortedPathsRules.length; a < t; a++)
        if (
          ((c = this.sortedPathsRules[a]), u.Utilities.startsWith(r, c.from))
        ) {
          let e = [];
      ...
      if (!u.Utilities.endsWith(c, ".js") && !u.Utilities.isAbsolutePath(c)) {
        ...
        for (let t = 0, e = a.length; t < e; t++)
          (this.isBuild() && a[t] === "empty:") ||
            (u.Utilities.isAbsolutePath(a[t]) ||
              (a[t] = this.options.baseUrl + a[t]),
    ...
    shouldInvokeFactory(r) {
      return !!(
        ...
        (this.options.buildForceInvokeFactory &&
          this.options.buildForceInvokeFactory[r])
      );
    }
...
(function (u) {
  ...
  function p(t) {
    ...
    try {
      return (
        (e ? self.eval(e.createScript("", "true")) : new Function("true")).call(
          self
        ),
        !0
      );
          ...
          if (!(g.length === 0 || g.length === d || o >= 5)) {
            ...
            (d = g.length),
              this._fs.writeFile(s, Buffer.concat([_, g]), (v) => {
                v && n.getConfig().onError(v),
                  n.getRecorder().record(63, s),
                  f();
              });
          }
        }, l * Math.pow(4, o++));
...
(function (u) {
  class y {
    constructor(t) {
      let e = t.lastIndexOf("/");
      e !== -1
        ? (this.fromModulePath = t.substr(0, e + 1))
        : (this.fromModulePath = "");
    }
  ...
  class c {
    ...
    _normalizeDependencies(t, e) {
      ...
      for (let n = 0, l = t.length; n < l; n++)
        i[s++] = this._normalizeDependency(t[n], e);
      return i;
    }
    ...
    _onLoadError(t, e) {
      ...
      let s = [];
      for (let d = 0, o = this._moduleIdProvider.getMaxModuleId(); d < o; d++)
        s[d] = !1;
      let n = !1,
        l = [];
    ...
    _hasDependencyPath(t, e) {
      ...
      if (!i) return !1;
      let s = [];
      for (let l = 0, d = this._moduleIdProvider.getMaxModuleId(); l < d; l++)
        s[l] = !1;
      let n = [];
        ...
        for (let i = 0, s = e.length; i < s; i++) {
          ...
          if (this._hasDependencyPath(n.id, t.id)) {
            ...
            d.reverse(),
              d.push(n.id),
              console.warn(
                d.map((o) => this._moduleIdProvider.getStrModuleId(o))
                  .join(` => 
`)
              ),
              t.unresolvedDependenciesCount--;
          ...
          if (
            ...
            o ||
              ((o = []), this._inversePluginDependencies2.set(n.pluginId, o)),
              o.push(n),
...
(function (u) {
  ...
  const p = function (a, t, e) {
    typeof a != "string" && ((e = t), (t = a), (a = null)),
      ...
      a
        ? m.defineModule(a, t, e, null, null)
        : m.enqueueDefineAnonymousModule(t, e);
  };
  p.amd = { jQuery: !0 };
  ...
  function c() {
    if (typeof u.global.require < "u" || typeof require < "u") {
      ...
      if (typeof a == "function" && typeof a.resolve == "function") {
        ...
        (u.global.nodeRequire = t),
          (r.nodeRequire = t),
          (r.__$__nodeRequire = t);
      }
    }
