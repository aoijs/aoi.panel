...
module.exports = (app, isLoggedIn, params) => {
  ...
  app.get('/interactions', isLoggedIn, function(req, res) {
    ...
    try {
      ...
      let ff = []
      for (const filePath of walkSync(path.join(process.cwd(), params.interaction))) {
        ff.push(filePath);
      }
...
<div class="w3-container w3-center">
  ...
  <a href="/interaction/edit?path=${pathh}"><button class="w3-button w3-green">Edit</button></a>
  <a href="/interaction/delete?path=${pathh}" onclick="alert("Are you sure you want to delete this file?");"><button class="w3-button w3-red">Delete</button></a>
</div>
